...
public class CloudJAASWebSession extends AbstractUserWebSession {
	...
	public CloudJAASWebSession(HttpServletRequest request,
		...
		this.containerSession.setAttribute(CLOUD_USER_WEB_SESSION, this);
	}
	...
	public String toString() {
		return "CloudJAASWebSession@" + authToken;
	}
