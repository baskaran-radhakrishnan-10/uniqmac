...
public class RoleDetailsRowMapper implements IRowMapper {
	...
	public JCPRoleDetails mapRow(ResultSet resultSet, int rowNumber)
		...
		//roleDetails.setRoleId(resultSet.getInt(1));
		//roleDetails.setLanguageCode(resultSet.getString(2));
		roleDetails.setRoleName(resultSet.getString(1));
		roleDetails.setRoleDescription(resultSet.getString(2));
