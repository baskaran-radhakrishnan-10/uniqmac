...
public class PrivilegePrincipal implements Principal, java.io.Serializable {
	...
	public PrivilegePrincipal(String privilegeName,int companyId) {
		this.privilegeName = privilegeName;
		this.companyId = companyId;
	}
	
	public PrivilegePrincipal(String privilegeName,int companyId,String instanceId) {
		this.privilegeName = privilegeName;
		this.companyId = companyId;
	...
	public String toString() {
		return PrivilegePrincipal.class + "@" + getName()+":companyId::"+getCompanyId();
	}
}
