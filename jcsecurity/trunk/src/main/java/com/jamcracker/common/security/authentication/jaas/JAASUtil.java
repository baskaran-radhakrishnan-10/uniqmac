...
public abstract class JAASUtil {
	...
	public static boolean isAccessPermitted(final Subject subj,
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("Trying to authorize subject : " + subject
		...
		try {
			...
			LOGGER.warn("AccessControlException occured : " + ace.getMessage());
			permissionGranted = false;
		} catch (PrivilegedActionException pae) {
			LOGGER.warn("PrivilegedActionException occured : " + pae.getMessage());
			permissionGranted = false;
		}
		if (LOGGER.isDebugEnabled()) {
