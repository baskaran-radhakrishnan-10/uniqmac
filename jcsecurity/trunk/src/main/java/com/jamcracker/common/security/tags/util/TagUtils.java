...
public class TagUtils {
	 ...
	 */
	public static String getContextRelativePath(final String url, final String context) {
		String retUrl=url;
		if (null != retUrl && null != context) {
			 ...
			 *   
			 */
			retUrl = maskDoubleSlashes(retUrl);
			
			final String [] pathArr = retUrl.split(context);
			return pathArr.length > 1 ? pathArr[1] : retUrl;
		}
