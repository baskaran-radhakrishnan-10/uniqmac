...
public final class SecurityAPIFactory {
	...
	public ISecurityAPI getSecurityAPI(AuthToken authToken) {
		try {
	 ...
	 * @return
	 */
	private ISecurityAPI setAuthToken(ISecurityAPI baseAPI,	AuthToken authToken) {
