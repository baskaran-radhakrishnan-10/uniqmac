...
public class FieldAccessPermission extends AbstractPermission {
	...
	public FieldAccessPermission(String jspURIfieldName, String accessType,String dynamicPermissionClassName) {
		super(jspURIfieldName, accessType,dynamicPermissionClassName);
