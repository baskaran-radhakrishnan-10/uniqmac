...
public interface ISecurityDAO extends IDAO {
    ...
    /**
     * This method will check if authorization is broken. True means broken.
     * @param String query
     * @param Map<String, Object> reqValueMap
     * @return boolean
     * @throws SecurityException
     */
    
    public boolean isAuthorizationBroken(String query, Map<String, Object> reqValueMap) throws SecurityException;
}
