...
public class KeyMgmtFaultCode extends JCFaultCode {
	...
	public static final KeyMgmtFaultCode PASSPHRASE_NOT_SET = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0005");
	public static final KeyMgmtFaultCode UNABLE_TO_UPDATE_LABEL_STAUS = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0006");
	public static final KeyMgmtFaultCode ERRROR_WHILE_VERIFYSIGNATURE = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0007");
	public static final KeyMgmtFaultCode PASSPHRASE_FILE_PERMISSION = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0008");
	public static final KeyMgmtFaultCode PASSPHRASE_FILE_NOTFOUND = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0009");
	public static final KeyMgmtFaultCode PASSPHRASE_FILE_EMPTY = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0010");
	public static final KeyMgmtFaultCode PASSPHRASE_FILE_DELETE_FAILURE = new KeyMgmtFaultCode(ERROR_VALIDATION, SUB_MODULE_KEY_MGMT, "0011");
}
