...
public abstract class AbstractSecurityProvider implements ISecurityProvider {
	 ...
	 * @return
	 */
	public abstract boolean canAccessURL(IJCAuthenticationToken authToken,
	 ...
	 * @return
	 */
	public abstract boolean canAccessEvent(IJCAuthenticationToken authToken,
			ResourceConfig resourceCfg);
	/**
	 ...
	 * @return
	 */
	public abstract boolean canAccessWidget(IJCAuthenticationToken authToken,
			ResourceConfig resourceCfg);
	 ...
	 * @return
	 */
	public abstract boolean canAccessField(IJCAuthenticationToken authToken,
			ResourceConfig resourceCfg);
	...
	public abstract boolean canAccessMenu(IJCAuthenticationToken authToken,
			ResourceConfig resourceCfg);
	 ...
	 */
	@Override
	public boolean canAccessResource(IJCAuthenticationToken authToken,
			ResourceConfig resourceCfg) {
	...
	public abstract IUserWebSession getWebSession(HttpServletRequest request,
