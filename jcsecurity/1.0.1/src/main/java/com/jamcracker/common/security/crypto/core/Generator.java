 ...
 */
class Generator {
	private static org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(Generator.class.getName());
	...
	public void setAlgorithm(final JCCryptoAlgorithm algorithm) {
	...
	public synchronized String generateSalt() throws JCCryptoException {
		try {
			...
			case JCCryptoConstants.SALTSIZE1:
				...
				RandomBytes_5 = new byte[RandomBytes_1.length];
				System.arraycopy(RandomBytes_1, 0, RandomBytes_5, 0,RandomBytes_1.length);
				break;
			case JCCryptoConstants.SALTSIZE2:
				prng.nextBytes(RandomBytes_1);
				prng.nextBytes(RandomBytes_2);
				RandomBytes_5 = new byte[RandomBytes_1.length+ RandomBytes_2.length];
				System.arraycopy(RandomBytes_1, 0, RandomBytes_5, 0,RandomBytes_1.length);
				System.arraycopy(RandomBytes_2, 0, RandomBytes_5,RandomBytes_2.length, RandomBytes_2.length);
				break;
			case JCCryptoConstants.SALTSIZE3:
				prng.nextBytes(RandomBytes_1);
				prng.nextBytes(RandomBytes_2);
				prng.nextBytes(RandomBytes_3);
				RandomBytes_5 = new byte[RandomBytes_1.length+ RandomBytes_2.length + RandomBytes_3.length];
				System.arraycopy(RandomBytes_1, 0, RandomBytes_5, 0,RandomBytes_1.length);
				System.arraycopy(RandomBytes_2, 0, RandomBytes_5,RandomBytes_2.length, RandomBytes_2.length);
				System.arraycopy(RandomBytes_3, 0, RandomBytes_5,RandomBytes_2.length + RandomBytes_3.length,RandomBytes_3.length);
				break;
			default:
				prng.nextBytes(RandomBytes_1);
				prng.nextBytes(RandomBytes_2);
				...
				RandomBytes_5 = new byte[RandomBytes_1.length+ RandomBytes_2.length + RandomBytes_3.length+ RandomBytes_4.length];
				System.arraycopy(RandomBytes_1, 0, RandomBytes_5, 0,RandomBytes_1.length);
				System.arraycopy(RandomBytes_2, 0, RandomBytes_5,RandomBytes_2.length, RandomBytes_2.length);
				System.arraycopy(RandomBytes_3, 0, RandomBytes_5,RandomBytes_2.length + RandomBytes_3.length,RandomBytes_3.length);
				System.arraycopy(RandomBytes_4, 0, RandomBytes_5,RandomBytes_2.length + RandomBytes_3.length+ RandomBytes_4.length, RandomBytes_4.length);
				break;
			}
			return new String(hex.encodeHex(RandomBytes_5));
		} catch (final NoSuchAlgorithmException e) {
