...
public class UserSessionFactory {
	...
	private static org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(UserSessionFactory.class.getName());
	...
	public IUserWebSession createUserSession(HttpServletRequest request,
			IJCAuthenticationToken authToken) throws AccessViolationException {
