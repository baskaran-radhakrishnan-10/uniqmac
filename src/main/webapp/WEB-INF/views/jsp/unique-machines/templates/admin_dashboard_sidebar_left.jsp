<aside class="main-sidebar sidebar-dark-primary elevation-4"
	...
	<a href="index3.html" class="brand-link"> <img
		src="/resources/unique-machines/admin-lte/images/AdminLTELogo.png" alt="AdminLTE Logo"
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="/resources/unique-machines/admin-lte/images/user2-160x160.jpg" class="img-circle elevation-2"
					alt="User Image">
			</div>
			<div class="info">
