...
<section class="banner-bottom" style="padding: 2em 0;">
	<div class="container">
		<h3 class="tittle" style="font-size: 2.5em;">OMRM 102B Automatic Single Corner PVC Profile Welding Machine</h3>
		<div class="row inner-sec">
			<!--left-->
			<div class="col-lg-12">
				<div class="blog-grid-top">
					<div class="sample1" style="border: 1px solid #c7c3c2;">
						
						<div class="carousel">
							<ul>
								<li class="">
									<img src="/resources/unique-machines/images/ImageVIewer/1.jpeg" alt="">
									<div class="caption1"><span></span></div>
									<div class="caption"><span></span></div>
								</li>
								<li class="">
									<img src="/resources/unique-machines/images/ImageVIewer/2.jpeg" alt="">
									<div class="caption1"><span></span></div>
									<div class="caption"><span></span></div>
								</li>
								<li class="">
									<img src="/resources/unique-machines/images/ImageVIewer/3.jpeg" alt="">
									<div class="caption1"><span></span></div>
									<div class="caption"><span></span></div>
								</li>
								<li class="">
									<img src="/resources/unique-machines/images/ImageVIewer/4.jpeg" alt="">
									<div class="caption1"><span></span></div>
									<div class="caption"><span></span></div>
								</li>
								<li class="">
									<img src="/resources/unique-machines/images/ImageVIewer/5.jpeg" alt="">
									<div class="caption1"><span></span></div>
									<div class="caption"><span></span></div>
								</li>
							</ul>
					...
					<div class="middle-grid w3-agile"
						...
						<div class="car-condition"
							...
							<ul class="col-md-12 col-sm-12"
								style="margin: 0px 36px; margin: 0px 36px; list-style-type: circle;">
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>For 45°~90° cutting plastic and aluminum
												profile.Various angle cutting is available.</strong>
										</p>
									</div></li>
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>Cutting limitation adjustable</strong>
										</p>
									</div></li>
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>Adopting the turn table location technology,
												high cutting precision.</strong>
										</p>
									</div></li>
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>Vertical and horizontal pneumatic clamping
												to ensure stable profile fixing.</strong>
										</p>
									</div></li>
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>With two sa w head, the left saw head is
												fixed,t he right saw head can move in left and right
												according to th e cut length.</strong>
										</p>
									</div></li>
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>With the additional intermediate supporting
												mechanism of equivalent length, convenient feed an d
												location.</strong>
										</p>
									</div></li>
								<li><div class="col-md-12 col-sm-12 part">
										<p>
											<strong>The saw head do fixed axis cycloid feed on
												the worktable's vertical side,cutting operation stable and
												reliable.</strong>
										</p>
									</div></li>
							</ul>
